...
import com.easyandroiddb.bean.BindSQL;
import com.easyandroiddb.bean.EntityTable;
import com.easyandroiddb.bean.PrimaryKey;
import com.easyandroiddb.manager.EntityTableManager;
import com.easyandroiddb.manager.SQLExecuteManager;
...
public class SQLiteDB {
	...
	public <T> List<T> query(Class<T> mClass, String whereClause, String[] whereArgs,String orderBy) {
		EntityTableManager.checkOrCreateTable(mSQLExecuteManager, mClass);
		Cursor cursor = mSQLExecuteManager.query(SQLBuilder.getQuerySQL(mClass, whereClause, orderBy,whereArgs));
		return CursorUtil.parseCursor(cursor, mClass);
	}
