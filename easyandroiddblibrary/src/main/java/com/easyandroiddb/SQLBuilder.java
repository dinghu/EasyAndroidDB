...
import com.easyandroiddb.annotation.Table;
...
import com.easyandroiddb.manager.FieldTypeManager;
...
public class SQLBuilder {
    ...
    public static String getTableName(Class<?> mClass) {
        Table anno = mClass.getAnnotation(Table.class);
    ...
    public static BindSQL getQuerySQL(Class<?> mClass, String whereClause,String orderBy, String[] whereArgs) {
        EntityTable entityTable = EntityTableManager.getEntityTable(mClass);
        StringBuilder sqlBuilder = new StringBuilder();
        sqlBuilder.append("SELECT * FROM ");
        sqlBuilder.append(entityTable.getTableName());
